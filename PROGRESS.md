...
1. Run and independently validate the frozen request-0 generated-source
   allocation canary. If it passes, run requests 1--9 without changing the
   scientific config. Do not label this population Level II.
